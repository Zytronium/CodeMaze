...
class Path8Activity(gamemode: Int) : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.path8_layout)
        ...
        val intent = Intent(this@Path8Activity, MainActivity(mode)::class.java)
