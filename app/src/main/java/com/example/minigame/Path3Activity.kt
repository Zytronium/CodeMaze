...
class Path3Activity(gamemode: Int) : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.path3_layout)
        ...
        val intent = Intent(this@Path3Activity, MainActivity(mode)::class.java)
