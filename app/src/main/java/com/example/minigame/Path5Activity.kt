...
class Path5Activity(gamemode: Int) : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.path5_layout)
        ...
        val intent = Intent(this@Path5Activity, MainActivity(mode)::class.java)
