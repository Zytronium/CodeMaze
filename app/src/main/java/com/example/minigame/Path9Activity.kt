...
class Path9Activity(gamemode: Int) : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.path9_layout)
        ...
        val intent = Intent(this@Path9Activity, MainActivity(mode)::class.java)
