...
class Path4Activity(gamemode: Int) : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.path4_layout)
        ...
        val intent = Intent(this@Path4Activity, MainActivity(mode)::class.java)
